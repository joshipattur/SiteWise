              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                {role === "professional" && (
                  <div>
                    ...
                    <select value={profession} onChange={(e) => setProfession(e.target.value)} className="w-full p-3 rounded-md border">
                ...
                {role === "contractor" && (
                  <div>
                    ...
                    <select value={category} onChange={(e) => setCategory(e.target.value)} className="w-full p-3 rounded-md border">
